...
const (
	IngestService_Ingest_FullMethodName = "/nominal.ingest.v2.IngestService/Ingest"
)
...
//
// Starts V2 ingest jobs and returns the RID used to track asynchronous progress.
type IngestServiceClient interface {
	// Submit a V2 ingest job.
...
var IngestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nominal.ingest.v2.IngestService",
	...
	Metadata: "nominal/protos/ingest/v2/ingest_service.proto",
}
